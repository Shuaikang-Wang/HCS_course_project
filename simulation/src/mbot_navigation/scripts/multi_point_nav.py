...
class MultiNav():  
    def __init__(self):  
        ...
        locations['point-1'] = Pose(Point(0.00, 0.00, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000)) 
        locations['point-2'] = Pose(Point(-0.50, -2.0, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000))
